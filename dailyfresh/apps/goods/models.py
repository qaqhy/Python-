...
class GoodsType(BaseModel):
    ...
    logo = models.CharField(max_length=20, verbose_name='标识')  # 设置类名
...
class IndexTypeGoodsBanner(BaseModel):
    ...
    display_type = models.SmallIntegerField(default=1, verbose_name='展示顺序', choices=DISPLAY_TYPE_CHOICES)
    index = models.SmallIntegerField(default=0, verbose_name='展示顺序')
